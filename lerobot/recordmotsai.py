...
def record_loop(
    ...
    while timestamp < (control_time_s or float("inf")):
        ...
        """
        Z	Avancer (x.vel positif)
        S	Reculer (x.vel négatif)
        Q	Aller à gauche (y.vel positif)
        D	Aller à droite (y.vel négatif)
        A	Tourner à gauche (theta.vel > 0)
        E	Tourner à droite (theta.vel < 0)"""
