...
class RecordConfig2:
    ...
    policy2_repo_id: str | None = None  # ✅ Ajout pour repo_id direct
    display_data: bool = False
    play_sounds: bool = True
    resume: bool = False
...
def create_dataset_from_config(dataset_config: DatasetRecordConfig, robot_config: RobotConfig) -> LeRobotDataset:
    """✅ Fonction helper pour créer le dataset correctement"""
    
    # ✅ Créer une instance temporaire du robot pour obtenir ses features
    try:
        ...
        # ✅ Fallback vers des features par défaut pour LeKiwi/SO100
    ...
    # ✅ Créer le dataset avec tous les paramètres nécessaires
    dataset = LeRobotDataset.create(
        repo_id=dataset_config.repo_id,
        fps=dataset_config.fps,
        features=features,
        root=dataset_config.root,
        robot_type=getattr(robot_config, 'robot_type', 'lekiwi'),  # ✅ Défaut vers lekiwi
...
def load_policy_from_hub(repo_id: str, dataset_meta=None):
    """✅ Helper pour charger une policy depuis le hub"""
    try:
        from lerobot.policies.pretrained import PreTrainedPolicy
...
def record1(cfg: RecordConfig1) -> LeRobotDataset:
    ...
    # ✅ Chargement de policy1 - soit depuis config CLI, soit depuis repo_id
    policy = None
    if cfg.policy1:
...
def record2(cfg: RecordConfig2) -> LeRobotDataset:
    ...
    # ✅ Chargement de policy2 - soit depuis config, soit depuis repo_id
    policy = None
    if cfg.policy2:
...
def policychoose(start_with: int, cfg1: RecordConfig1, cfg2: RecordConfig2):
    """✅ Fonction pour alterner entre les policies"""
    global switch_requested
    current = start_with
...
def main(cfg_cli: RecordConfig1):
    ...
    cfg1 = RecordConfig1(
        ...
        teleop1=cfg_cli.teleop1,  # ✅ Utilise teleop1 du CLI
        policy1=cfg_cli.policy1,  # ✅ Utilise policy1 du CLI
